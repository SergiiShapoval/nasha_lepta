        ...
        editor.widgets.add( 'widgetbootstrapTwoCol', {
            ...
            template:
                '<div class="row two-col">' +
                    '<div class="col-md-6 col-1"><p><img class="pop-up img-responsive thumbnail" src="http://placehold.it/500x280&text=Image" /></p><p>Content</p></div>' +
                    '<div class="col-md-6 col-2"><p><img class="pop-up img-responsive thumbnail" src="http://placehold.it/500x280&text=Image" /></p><p>Content</p></div>' +
                '</div>',
